...
*
*       range(min, max, d) returns sorted array in range (min, max)
*       min inclusive, max exclusive, iterates by d
*/
...
function range() {
    var min; var max; var d;
    var arg = range.arguments;
    ...
    if (arg.length == 1) {
        ...
        min = arg[0]; max = arg[1]; d = 1;
    }
    
    else if (arg.length == 3) {
        min = arg[0]; max = arg[1]; d = arg[2];
    }
